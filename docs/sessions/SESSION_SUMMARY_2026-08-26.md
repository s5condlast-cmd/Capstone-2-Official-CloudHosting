...
2. **[`src/components/ui/Skeleton.tsx`](../../src/components/ui/Skeleton.tsx)**:
...
4. **[`src/components/ui/Badge.tsx`](../../src/components/ui/Badge.tsx)**:
...
5. **[`src/components/ui/Card.tsx`](../../src/components/ui/Card.tsx)**:
   - Added `subtitle?: string` to `CardProps` and updated the header section to display subtitles cleanly under card titles.

6. **[`src/components/compose/StructuredDocumentRenderer.tsx`](../../src/components/compose/StructuredDocumentRenderer.tsx)**:
