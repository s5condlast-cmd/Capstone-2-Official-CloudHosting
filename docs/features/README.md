...
[Documentation home](../README.md) | [Architecture](../architecture/README.md) | [Tasks](../tasks/README.md)

Use these guides when you need the user workflow, main code locations, data flow, and invariants for a feature.

| # | Feature | Main concern |
| ---: | --- | --- |
| 1 | [Student portal and practicum checklist](01_STUDENT_PORTAL_CHECKLIST.md) | Stage progress, placement, and requirements |
| 2 | [Digital document pipeline](02_DOCUMENT_PIPELINE.md) | Template preview, editing, generation, and export |
| 3 | [DTR attendance and signatures](03_DTR_ATTENDANCE_SIGNATURE.md) | Hours, supervisor signing, and Excel output |
| 4 | [AI-assisted document audit](04_AI_GRAMMAR_AUDIT.md) | Document analysis and adviser feedback |
