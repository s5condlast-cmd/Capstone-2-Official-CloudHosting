  ...
  ({ className, variant = 'primary', size = 'md', icon, children, ...props }, ref) => {
    ...
    return (
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
        className={cn(
          'inline-flex items-center justify-center gap-2 font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/20 active:scale-[0.98]',
          variants[variant],
          sizes[size],
          className
        )}
