  ...
  function PlateEditor(
    ...
    return (
      <PlateComp editor={editor} onValueChange={handleChange} readOnly={isEffectivelyReadOnly}>
        <div
          className={cn(
            'plate-editor-wrapper relative flex flex-col flex-1 min-h-0 h-full overflow-hidden transition-all',
          ...
          <div className="flex-1 flex flex-row min-h-0 overflow-hidden relative">
            ...
            <div ref={canvasRef} className="relative flex-1 flex flex-col min-h-0 overflow-hidden bg-[#f0f4f9] dark:bg-zinc-950">
              <EditorContainer
                ...
                className={cn(
                  'flex-1 h-full min-h-0 overflow-y-auto bg-transparent p-4 md:p-8',
