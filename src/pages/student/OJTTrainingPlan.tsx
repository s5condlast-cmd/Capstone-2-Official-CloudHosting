...
import { Upload, MessageSquare, Clock, CheckCircle2, AlertCircle, Info } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {TRAINING_PLAN_TEMPLATES.map((template, idx) => (
                <button
                  ...
                  className={cn(
                    "px-3 py-2 rounded-lg text-[10px] sm:text-xs font-bold uppercase tracking-wider transition-all border flex items-center gap-2 cursor-pointer",
