                ...
                <div className="flex items-center gap-2.5 min-w-0">
                  {titleEditing ? (
                    <input
                      ...
                      className="text-lg sm:text-[19px] font-semibold leading-tight bg-transparent border-b border-primary focus:outline-none text-zinc-900 dark:text-zinc-100 py-0.5 px-0.5 min-w-[200px] max-w-[500px] shrink-0"
                      maxLength={120}
                    />
                  ) : (
                    <button
                      ...
                      className={cn(
                        'text-lg sm:text-[19px] font-semibold leading-tight text-zinc-900 dark:text-zinc-100 text-left truncate min-w-[150px] max-w-[500px] shrink-0',
...
function TelemetryStrip({
  ...
  return (
    <div
      ...
      className="flex items-center gap-1.5 text-xs sm:text-sm text-zinc-500"
    >
