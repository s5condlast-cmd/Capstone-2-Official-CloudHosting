...
import { JournalPreview } from '@/src/components/templates/JournalPreview';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col h-full">
          <DocumentWorkflow
            ...
            previewComponent={JournalPreview}
          />
        </div>
          ...
          >
            <div className="space-y-5">
              <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed bg-zinc-50 dark:bg-zinc-800/50 p-3 rounded-lg border border-zinc-100 dark:border-zinc-800">
                Weekly journals document your daily activities, challenges, and learnings. Submit your compiled journal entries for the {milestones[activeTab]} period.
              </p>
