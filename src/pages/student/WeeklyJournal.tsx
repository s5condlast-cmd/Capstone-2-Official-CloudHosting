          ...
          >
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-2 pt-2 border-t border-zinc-200/80 dark:border-zinc-800/80">
                ...
                <div className="pt-1">
                  <a
                    href={onedriveUrl || "https://onedrive.live.com?cid=D9646D9033CEACF0&id=D9646D9033CEACF0!sbcec97914ef14503aaaa786bd628bc60"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className={cn(
                      "flex items-center justify-between p-2.5 rounded-xl border text-xs font-semibold transition-all group",
                      isSubmitted || onedriveUrl
                  ...
                  >
                    <div className="flex items-center gap-2 min-w-0">
                      <Cloud size={16} className={isSubmitted || onedriveUrl ? "text-emerald-500" : "text-sky-500"} />
                      <div className="flex flex-col text-left truncate">
                        <span className="font-bold text-[11px] leading-tight text-zinc-900 dark:text-zinc-100">
                          {isSubmitted || onedriveUrl ? 'Archived in Microsoft OneDrive' : 'OneDrive Sync Connected'}
                        </span>
