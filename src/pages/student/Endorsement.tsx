...
import { EndorsementPreview } from '@/src/components/templates/EndorsementPreview';
...
export const Endorsement = () => {
  ...
  const adminComments = [
    { author: 'Admin Office', msg: 'Endorsement request received. Processing within 2-3 business days.', time: 'April 25, 2026' },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 flex flex-col h-full">
          <DocumentWorkflow
            ...
            previewComponent={EndorsementPreview}
          />
        </div>
