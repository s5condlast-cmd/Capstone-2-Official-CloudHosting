          ...
          <AnimatePresence mode="wait" custom={direction}>
            ...
            {step === 'credentials' && (
              ...
              >
                ...
                {/* ── Quick Account Switcher (1-Click Instant Login) ── */}
                <div className="mb-6 bg-zinc-50 dark:bg-zinc-900/80 p-3 rounded-xl border border-zinc-200/80 dark:border-zinc-800 text-center">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 block mb-2">
                    ⚡ Quick Account Switcher (1-Click Login)
                  </span>
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                    <button
                      type="button"
                      onClick={() => onLogin('student', 'student')}
                      className="px-2 py-2 rounded-lg bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 hover:border-zinc-400 dark:hover:border-zinc-600 text-[11px] font-semibold text-zinc-800 dark:text-zinc-200 transition-all flex flex-col items-center gap-1 cursor-pointer shadow-2xs hover:scale-105"
                    >
                    ...
                    <button
                      type="button"
                      onClick={() => onLogin('adviser', 'adviser')}
                      className="px-2 py-2 rounded-lg bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 hover:border-zinc-400 dark:hover:border-zinc-600 text-[11px] font-semibold text-zinc-800 dark:text-zinc-200 transition-all flex flex-col items-center gap-1 cursor-pointer shadow-2xs hover:scale-105"
                    >
                    ...
                    <button
                      type="button"
                      onClick={() => onLogin('supervisor', 'supervisor')}
                      className="px-2 py-2 rounded-lg bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 hover:border-zinc-400 dark:hover:border-zinc-600 text-[11px] font-semibold text-zinc-800 dark:text-zinc-200 transition-all flex flex-col items-center gap-1 cursor-pointer shadow-2xs hover:scale-105"
                    >
