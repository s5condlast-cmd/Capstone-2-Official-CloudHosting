...
/**
 * ==============================================================================
 * CLOUDINARY ROUTER (PRESERVED IN COMMENTS FOR FUTURE REDESIGN / REACTIVATION)
 * ==============================================================================
 *
...
// Fallback route handler returning disabled status
router.all('/cloudinary/*', (_req: Request, res: Response) => {
  return res.status(503).json({
    error: 'Cloudinary integration is currently inactive and preserved in comments for future redesign.',
  });
});
